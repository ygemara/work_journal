...
# ── connection (cached for the lifetime of the server process) ────────────────
...
try:
    issues_df  = get_data("Issues")
    actions_df = get_data("ActionItems")
    agenda_df  = get_data("Agenda")
    emails_df  = get_data("Emails")
